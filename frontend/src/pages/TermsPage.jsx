...
const TermsPage = () => {
  ...
  return (
    ...
    >
      ...
      <LegalSection title={isTR ? '3. Hesap ve İlerleme' : '3. Account and Progress'}>
        <p>
          {isTR
      ...
      <LegalSection title={isTR ? '4. Reklamlar, Ödüller ve Premium' : '4. Ads, Rewards, and Premium'}>
        <p>
          {isTR
      ...
      <LegalSection title={isTR ? '7. Hizmet Değişiklikleri' : '7. Service Changes'}>
        <p>
          {isTR
      ...
      <LegalSection title={isTR ? '9. Sonlandırma' : '9. Termination'}>
        <p>
          {isTR
